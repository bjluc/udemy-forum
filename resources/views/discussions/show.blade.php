...
<div class="panel panel-default">
    ...
    @if(Auth::id() == $r->user->id)
        ...
        <a href="{{ route('reply.edit', ['id' => $r->id ]) }}" class="btn btn-xs btn-info pull-right" style="margin-right: 8px;">Edit</a>
    ...
    <div class="panel-footer">
        ...
        <a href="{{ route('reply.unlike', ['id' => $r->id ]) }}" class="btn btn-danger btn-xs">Unlike <span class="badge">{{ $r->likes->count() }}</span></a> @else
